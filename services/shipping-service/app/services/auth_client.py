...
class AuthClient:
    ...
    token carrying the orders:fulfillment scope, for calling Order's
    internal fulfillment callback."""
    ...
    async def service_token(self) -> str:
        ...
        try:
            response = await client.post(
                ...
                json={
                    "client_id": self.settings.shipping_service_client_id,
                    "client_secret": self.settings.shipping_service_client_secret,
                },
            )
