...
class AuthClient:
    ...
    token carrying the orders:payment scope, for calling Order's internal
    payment-authorized / payment-failed callbacks."""
    ...
    async def service_token(self) -> str:
        ...
        try:
            response = await client.post(
                ...
                json={
                    "client_id": self.settings.payment_service_client_id,
                    "client_secret": self.settings.payment_service_client_secret,
                },
            )
